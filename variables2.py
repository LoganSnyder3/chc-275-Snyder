...
For example, if we want to have a calculator, we would want the user to be able to
...
input(<prompt>) <= this function does 3 things
    ...
    1) t prints the prompt into the terminal
...
numsix = "Logan Snyder" <- i want to typecast this into a number
numsix = "10" <- I can typecast

to change a string -> int
"""
